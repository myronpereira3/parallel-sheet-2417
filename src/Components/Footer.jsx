    ...
    return (
      <Box
        ...
        <Container as={Stack} maxW={'6xl'} py={10}>
          <SimpleGrid textAlign='left' columns={{ base: 1, sm: 2, md: 6 }} spacing={8}>
            <Stack align={'flex-start'}>
              <ListHeader>Product</ListHeader>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Features</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Integrations</Link>             
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Applications</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Product updates</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Customer Stories</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Self-hosting</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>Support</ListHeader>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Support</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Knowledge base</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Developers API</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Server Status</Link>             
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>Integrations</ListHeader>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Trello</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Monday.com</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Google Calendar</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Asana</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Jira</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>All integrations</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>Resources</ListHeader>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Contact</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>HeySpace</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>About us</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Press</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Become a Partner</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>Calculators</ListHeader>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Profit Margin Calculator</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Online Timer</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Overtime Calculator</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>ROI Calculator</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Time Card Calculator</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>Legal</ListHeader>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Terms</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Privacy</Link>
              <Link _hover={{color: 'orange', textDecor: 'none'}} href={'#'}>Security</Link>              
            </Stack>           
          </SimpleGrid>
        </Container>

        <Box py={10}>
            <Flex color='#ddd' justify='center' align='center' gap='30px'>
                <FaFacebookF/>
                <FaLinkedinIn/>
                <AiOutlineTwitter/>
            </Flex>
          ...
          <Text pt={6} fontSize={'sm'} textAlign={'center'}>
            <Text color='#c5c5c2' fontWeight='semibold'>Copyright © 2022 TimeCamp. Inc.</Text>
            <Text color='#ddd' fontSize='11px' fontWeight=''>We use cookies. Click here to learn more</Text>
          </Text>
        </Box>
      </Box>
    );
